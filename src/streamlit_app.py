...
from streamlit_functions import (introduction,
                                 annual_analysis,
...
MODES = ['Descriptive Statistics', 'Time Series Analysis',
         'Extreme Value Analysis', 'Time Series Visualization', 'Time Series Analysis']
...
INFO = st.sidebar.radio("Content", ('Project description', 'Mean Temperature at Geneva Observatory',
                        'Extreme Value Analysis', 'Data Visualization'))
