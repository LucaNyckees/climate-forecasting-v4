...
def max_min_analysis():
    ...
    SELECTED_MONTH1 = st.selectbox("Choose a month to view its Mean Residual  Life plot",
                                   calendar.month_name[1:], index=0)
    ...
    SELECTED_MONTH2 = st.selectbox("Choose a month to view its Parameters Stability plot",
                                   calendar.month_name[1:], index=0)
    ...
    SELECTED_MONTH4 = st.selectbox("Choose a month to view its profile likelihood plot",
                                   [calendar.month_name[i] for i in dd], index=0)
    ...
    SELECTED_MONTH5 = st.selectbox("Choose a month to view the diagnostic plot of the Gumbel fit", [
                                   calendar.month_name[i] for i in dd], index=0)
